...
plt.text(x[1] + 0.01, baseline_scores[model_name]['Label Acc'] - 0.125, f'{model_name.upper()} Acc(Y)', color='maroon',
...
save_path = f".pdfs/mnist-plots/hidden_digits/{model_name}_acc_hidden_classes_mean_results_trend.pdf"
...
# Save the plot instead of showing it.
save_path = f".pdfs/mnist-plots/hidden_digits/{model_name}_f1_score_hidden_classes_mean_results_trend.pdf"
plt.savefig(save_path, dpi=300, bbox_inches='tight')
plt.close()
...
# Save the plot instead of showing it.
save_path = f".pdfs/mnist-plots/hidden_digits/{model_name}_{collapse_flag}_collapse_score_hidden_classes_mean_results_trend.pdf"
plt.savefig(save_path, dpi=300, bbox_inches='tight')
plt.close()
