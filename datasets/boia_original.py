...
class BDDDataset(BaseDataset):
    ...
    NAME = "boia_original"
    # & Original init with args and super call
    def __init__(self=None, 
        ...
        if args is not None:
            super().__init__(args)
            print("Original BOIA dataset has been created.")
            return
    ...
    # & Original __len__ and __getitem__ methods
    def __len__(self):
    ...
    def get_data_loaders(self, batch_size):
        ...
        valid_loader = load_data([val_data_path], 
                                True, 
                                False, 
                                batch_size, 
                                uncertain_label=False, 
...
def load_data(pkl_paths, 
    ...
    dataset = BDDDataset(None, pkl_paths, use_attr, no_img, uncertain_label, image_dir, n_class_attr, transform)
    if is_training:
        drop_last = True
        shuffle = True
    else:
