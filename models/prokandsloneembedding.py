...
# ! Model Class
class ProKandSLOneEmbedding(CExt):
    """Kandinsky DPL model"""
    NAME = "prokandsloneembedding"
    ...
    def __init__(self, encoder, n_images=3, c_split=(), args=None, n_facts=6, nr_classes=2):
        ...
        """
        super(ProKandSLOneEmbedding, self).__init__(encoder=encoder, n_images=n_images, c_split=c_split)
    ...
    def forward(self, x, concept_extractor, transform, support_images, support_labels, args, unknown_init=False):    
        ...
        for i in range(self.n_images):
            ...
            _, _, colors_logits = self.encoder[0].predict(support_images_colors, support_color_labels, cropped_objects, unknown_init=unknown_init) # ^ (96,3)
