...
class ShieldedMNIST(torch.nn.Module):
    ...
    def __init__(
        ...
        super(ShieldedMNIST, self).__init__()
        
        custom_ordering = ",".join(str(i) for i in range((n_facts * 2) + nr_classes))
    ...
    def forward(self, x):
        ...
        """
        # ^ get the logits for each digit (disentanglement)
        cs = []
