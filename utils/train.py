...
#^: I added this method to compute the coverage of a confusion matrix
def compute_coverage_hard(confusion_matrix):
    """Compute the hard coverage of a confusion matrix.

    This metric is defined as the proportion of the diagonal elements
    (correct predictions) over the total number of elements.
    """
    correct_predictions = np.trace(confusion_matrix)
    total_predictions = np.sum(confusion_matrix)
    coverage_hard = correct_predictions / total_predictions
    return coverage_hard
